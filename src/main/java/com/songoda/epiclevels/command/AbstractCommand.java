...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(EpicLevels instance, CommandSender sender, String... args);

    protected abstract List<String> onTab(EpicLevels instance, CommandSender sender, String... args);
